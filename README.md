...
> ⚠️ Ne commitez jamais votre fichier `.env`. Il est listé dans `.gitignore`.
...
> ⚠️ Si une question dépasse ce périmètre, le système le signale explicitement sans inventer de réponse.
